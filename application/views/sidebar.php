  ...
  <aside class="main-sidebar">
    ...
    <?php if($CI->permissions('item_purchase_report') ||$CI->permissions('sales_report') || $CI->permissions('item_sales_report') || $CI->permissions('purchase_report') || $CI->permissions('purchase_return_report') || $CI->permissions('expense_report') || $CI->permissions('profit_report') || $CI->permissions('stock_report') || $CI->permissions('purchase_payments_report') || $CI->permissions('sales_payments_report') || $CI->permissions('expired_items_report')) { ?>
		<li class="report-sales-active-li report-sales-return-active-li report-purchase-active-li report-purchase-return-active-li report-expense-active-li report-profit-loss-active-li report-stock-active-li report-purchase-payments-active-li report-sales-item-active-li report-sales-payments-active-li report-expired-items-active-li report-purchase-item-active-li treeview">
          <a href="#">
            <i class="fa fa-credit-card text-aqua"></i> <span> Accounting</span>
            <span class="pull-right-container">
          ...
          <?php if($CI->permissions('profit_report')) { ?>
            <li class="report-profit-loss-active-li"><a href="<?php echo $base_url; ?>account/add" ><i class="fa fa-list "></i> <span>Account Head</span></a></li>
            
            <?php } ?>

            <?php if($CI->permissions('profit_report')) { ?>
            <li class="report-profit-loss-active-li"><a href="<?php echo $base_url; ?>account" ><i class="fa fa-list "></i> <span>Account Head List</span></a></li>
            <?php } ?>

            
            <?php if($CI->permissions('purchase_report')) { ?>
            <li class="report-purchase-active-li"><a href="<?php echo $base_url; ?>account_main/add" ><i class="fa fa-plus-square-o "></i> <span>Add Account</span></a></li>
            <?php } ?>

            <?php if($CI->permissions('profit_report')) { ?>
            <li class="report-profit-loss-active-li"><a href="<?php echo $base_url; ?>account_main" ><i class="fa fa-list "></i> <span>Account List</span></a></li>
            <?php } ?>

            <!-- <?php if($CI->permissions('purchase_return_report')) { ?>
            <li class="report-purchase-return-active-li"><a href="<?php echo $base_url; ?>account/money_transfer" ><i class="fa fa-arrow-circle-o-left"></i> <span> Money Transfer</span></a></li>
            <?php } ?> -->

            <?php if($CI->permissions('item_sales_report')) { ?>
            <li class="report-sales-item-active-li"><a href="<?php echo $base_url; ?>trial_balance" ><i class="fa fa-files-o "></i> <span> Trial Balance</span></a></li>
            <?php } ?>
            
            <?php if($CI->permissions('purchase_payments_report')) { ?>
            <li class="report-purchase-payments-active-li"><a href="<?php echo $base_url; ?>balance_sheet" ><i class="fa fa-files-o "></i> <span> Balance Sheet</span></a></li>
            <?php } ?>
    ...
    <?php if($change_password=true) { ?>
		<li class=" company-profile-active-li site-settings-active-li  change-pass-active-li dbbackup-active-li warehouse-active-li warehouse-list-active-li tax-active-li currency-view-active-li currency-active-li  database_updater-active-li tax-list-active-li units-list-active-li unit-active-li payment_types_list-active-li payment_types-active-li treeview">
          ...
          <ul class="treeview-menu">
            ...
            <?php } ?>
            <?php if($CI->permissions('branch_view')) { ?>
    <li class="branches-active-li">
        <a href="<?php echo $base_url; ?>branches">
            <i class="fa fa-building"></i>
            <span><?= $this->lang->line('branch_settings'); ?></span>
        </a>
    </li>
<?php } ?>
