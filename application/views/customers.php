        ...
        <div class="row">
          ...
          <div class="col-md-12">
                    ...
                    <div class="col-md-5">
                      <div class="form-group">
                        <label for="customer_name"
                          class="col-sm-4 control-label"><?= $this->lang->line('customer_name'); ?><label
                      ...
                      <div class="form-group">
                        <label for="gstin"
                          class="col-sm-4 control-label"><?= $this->lang->line('gst_number'); ?></label>
                        <div class="col-sm-8">
                      ...
                      <div class="form-group">
                        <label for="tax_number"
                          class="col-sm-4 control-label"><?= $this->lang->line('tax_number'); ?></label>
                        <div class="col-sm-8">
                    ...
                    <div class="col-md-5">
                      ...
                      <div class="form-group">
                        <label for="opening_balance"
                          class="col-sm-4 control-label"><?= $this->lang->line('opening_balance'); ?></label>
                        <div class="col-sm-8">
            ...
            ?>
                      ...
                      <div class="form-group">
                        <label for="postcode"
                          class="col-sm-4 control-label"><?= $this->lang->line('postcode'); ?></label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control no_special_char_no_space" id="postcode" name="postcode"
                            placeholder="" value="<?php print $postcode; ?>">
