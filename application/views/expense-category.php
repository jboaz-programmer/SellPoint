...
<div class="wrapper">
 ...
 <?php
	if(!isset($category_name)){
      $category_code=$category_name=$description=$account_head="";
	}
 ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="form-group">
			      <label for="category" class="col-sm-2 control-label">Account <Head></Head><label class="text-danger">*</label></label>
           <div class="col-sm-4">
           <select class="form-control select2" id="account_head" name="account_head" style="width: 100%;"
                            onkeyup="shift_cursor(event,'account_head')" value="<?php print $account_head; ?>">
                            <?php
                        $query1="select * from db_account_header where status=1";
                        ...
                        if($q1->num_rows($q1)>0)
                         {  echo '<option value="">-Select-</option>'; 
                           ...
                           { 
                             ...
                             echo "<option $selected value='".$res1->id."'>".$res1->ac_name."</option>";
                           }
                         }
                         else
                         {
