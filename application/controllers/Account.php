...
class Account extends MY_Controller {
	...
	public function index(){
        ...
        // print_r($data);
        // exit();
		$this->load->view('account-head-list', $data);
	}

	public function newaccount_head(){
		$this->form_validation->set_rules('ac_code', 'Code', 'trim|required');
	...
	public function ajax_list()
	{
		...
		foreach ($list as $country) {
			...
			$row[] = $country->ac_code;
			$row[] = $country->ac_name;
			$row[] = $country->new_balance;
			$row[] = $country->created_at;
