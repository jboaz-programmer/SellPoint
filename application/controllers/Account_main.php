...
class Account_main extends MY_Controller {
	...
	public function index(){
		...
		$data=$this->data;
		$data['page_title']="Account Main list";
		// echo "<pre>";
        // print_r($data);
        // exit();
			...
			$row[] = $country->ac_type;
			         ...
			         $str2 = '<div class="btn-group" title="View Account">
										...
										<ul role="menu" class="dropdown-menu dropdown-light pull-right">';
											...
											$str2.='<li>
												<a title="Edit Record ?" href="account_main/update/'.$country->id.'">
