...
class Users_model extends CI_Model {
	...
	public function verify_and_save(){
		...
		created_date,created_time,created_by,system_ip,system_name,status,profile_picture,branch_id) 
									values('$new_user','$pass','$mobile','$email',$role_id,
									'$CUR_DATE','$CUR_TIME','$CUR_USERNAME','$SYSTEM_IP','$SYSTEM_NAME',1,'$profile_picture',$branch_id)";
		//echo $query1;exit();
